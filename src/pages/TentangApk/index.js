        ...
        <ScrollView>
            ...
            <View style={{backgroundColor:'#4169E1', height:75}}>
                <View style={{left:15, marginTop:25, flexDirection:'row'}}>
                    ...
                    <Text style={styles.text_header}>GetHaircut Application - Tentang Aplikasi</Text>
                </View>
            </View>
            <View style={styles.textPrivate}>
                ...
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Salon/Barbershop terdekat dari</Text>
                <Text style={styles.color_textPrivate}>
