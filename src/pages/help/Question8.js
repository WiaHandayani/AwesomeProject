    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Cara membatalkan pesanan saya</Text>
            </View>
            <View style={styles.textPrivate}>
                ...
                <Text style={styles.color_textPrivate}>
                    {" "}pesanan Anda kapanpun selama
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}pesanan tersebut belum di
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}'accept' oleh pihak
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}salon/barbershop terkait.
                </Text>
             </View>
