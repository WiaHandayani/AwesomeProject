    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Cara mengubah</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}profil saya</Text>
            </View>
            <View style={styles.textPrivate}>
                <Text style={styles.color_textPrivate}>
                    {" "}Masuk ke menu 'Akun' (setelah
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}login) lalu klik icon 'Edit' maka
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}Anda bisa mengubah profil Anda.
                </Text>
             </View>
