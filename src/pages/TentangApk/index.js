      ...
      <ScrollView>
        ...
        <View style={{backgroundColor: '#4169E1', height: 75}}>
          <View style={{left: 15, marginTop: 25, flexDirection: 'row'}}>
            ...
            <Text style={styles.text_header}>
              GetHaircut Application - Tentang Aplikasi
            </Text>
          </View>
        </View>
        <View style={styles.textPrivate}>
          <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>
            {' '}
            Aplikasi Get Haircut
          </Text>
          <Text style={styles.color_textPrivate}> adalah</Text>
          ...
          <Text style={styles.color_textPrivate}>
            {' '}
            layanan jasa pemesanan untuk
          </Text>
          <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>
            {' '}
            Salon/Barbershop terdekat dari
          </Text>
          <Text style={styles.color_textPrivate}>
            {' '}
            alamat pelanggan di Wilayah
          </Text>
          <Text style={styles.color_textPrivate}> Cirebon.</Text>
        </View>
        <View style={styles.textPrivate2}>
          <Text style={[styles.color_textPrivate2, {fontWeight: 'bold'}]}>
            {' '}
        ...
        <View style={styles.userInfoSection}>
          <View style={styles.row}>
            ...
            <Text style={{color: '#777777', marginLeft: 20}}>
              Jalan Nyi Mas Endang Geulis Danawinangun, Klangenan - Kabupaten
              Cirebon
            </Text>
          </View>
          <View style={styles.row}>
          ...
          <View style={styles.row}>
            ...
            <Text style={{color: '#777777', marginLeft: 20}}>
              gethaircutapplication@gmail.com
            </Text>
          </View>
        </View>
      </ScrollView>
