    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Tidak dapat melakukan</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}pemesanan</Text>
            </View>
            <View style={styles.textPrivate}>
                ...
                <Text style={styles.color_textPrivate}>
                    {" "}mungkin saja terjadi karena pada
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}salon/barbershop yang dituju 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}sedang memiliki banyak antrian
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}sehingga otomatis aplikasi ini
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}melakukan 'reject'.
                </Text>
