...
const kodeOtp = ({navigation, route}) => {
    ...
    return (
      <View style={styles.container}>
        ...
        >
            <ScrollView>
            <Text style={styles.color_textPrivate}>Silahkan masukkan kode otp yang telah dikirim ke alamat e-mail anda!</Text>
            ...
            <View style={styles.action}>
                <TextInput 
                    ...
                    autoCapitalize="none"
                    value={form.otp} onChangeText={(value)=>onInputChange(value, 'otp')}
                />
            </View>
