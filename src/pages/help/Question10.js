    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Cara mengganti</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}alamat saya</Text>
            </View>
            <View style={styles.textPrivate}>
