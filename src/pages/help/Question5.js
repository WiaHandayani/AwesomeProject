    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Barberman meminta</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}pembayaran lebih dari yang</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}tertera di aplikasi</Text>
            </View>
            <View style={styles.textPrivate}>
                ...
                <Text style={styles.color_textPrivate}>
                    {" "}mungkin saja terjadi karena Anda
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}menambah pelayanan ataupun
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}data harga pelayanan yang belum
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}di update oleh pihak
                </Text>
                <Text style={styles.color_textPrivate}>
