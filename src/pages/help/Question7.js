    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Cara mendapatkan struk</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}pemesanan</Text>
            </View>
            <View style={styles.textPrivate}>
                <Text style={styles.color_textPrivate}>
                    {" "}Anda bisa langsung klik tombol 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}'cetak' pada halaman pemesanan
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}Anda, maka struk pemesanan
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}akan langsung masuk ke alamat
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}e-mail anda.
                </Text>
