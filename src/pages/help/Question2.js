    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Cara melakukan pemesanan di</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Aplikasi Get Haircut</Text>
            </View>
            <View style={styles.textPrivate}>
                <Text style={styles.color_textPrivate}>
                    {" "}1. Pada menu "Beranda" (Ketika 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    sudah Login), masukkan 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    alamat anda pada kolom
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    pencarian lalu akan tampil
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    salon/barbershop terdekat
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    dari alamat anda, pilih salah
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    satu kemudian pilih pelayanan
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    dan klik pesan.
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}2. Pada menu "Cari" (Ketika 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    sudah Login), masukkan 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    salon/barbershop yang ingin
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    anda tuju lalu nanti akan tampil 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    salon/barbershop tersebut 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    kemudian pilih pelayanan
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}    dan klik pesan.
                </Text>
