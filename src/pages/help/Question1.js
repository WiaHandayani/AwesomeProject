    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Kenapa harus menggunakan</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Aplikasi Get Haircut?</Text>
            </View>
            <View style={styles.textPrivate}>
                <Text style={styles.color_textPrivate}>
                    {" "}aplikasi ini mampu menemukan
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}salon/barbershop terdekat dari 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}alamat pelanggan dan sekaligus
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}dapat melakukan pemesanan
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}untuk salon/barbershop tersebut.
                </Text>
             </View>
