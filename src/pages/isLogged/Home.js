...
import { Image, StyleSheet, Text, TextInput, TouchableOpacity, StatusBar, View, ScrollView, RefreshControl, LogBox } from 'react-native'
import Swiper from 'react-native-swiper';
import { banner_1, banner_2, banner_3, cewek, cowok, love, mata, showmore, uang, Aktivitas, HomeIcon, User, cari, riwayat } from '../../assets';
            ...
            <Text style={styles.text_header2}>Hai, {nama}!</Text>
                <View style={{marginHorizontal: 17, flexDirection:'row', paddingTop:15}}>
                    <View style={{position: 'relative', flex:1}}>
                        <TextInput placeholder="Masukkan Alamat Anda" style={{borderWidth:1, borderColor:'#E8E8E8', 
        ...
        <View style={{height:54, flexDirection:'row'}}>
            <View style={{ flex:1, alignItems:'center', justifyContent:'center'}}>
                <TouchableOpacity onPress={() => navigation.navigate('Home')} >
                    ...
                    <Text style={{fontSize:12, color:'#545454', color:colors.default, marginTop:4}}>Beranda</Text>
                    </TouchableOpacity>
            </View>
            <View style={{ flex:1, alignItems:'center', justifyContent:'center'}}>
