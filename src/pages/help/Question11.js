    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Kualitas pelayanan yang saya</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}terima kurang baik</Text>
            </View>
            <View style={styles.textPrivate}>
                ...
                <Text style={styles.color_textPrivate}>
                    {" "}diluar kendali pihak Get Haircut,
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}namun, jika terjadi silahkan 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}hubungi kami melalui kontak dan
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}alamat yang tertera dibawah ini.
                </Text>
             </View>
