    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Barberman membatalkan</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}pesanan</Text>
            </View>
            <View style={styles.textPrivate}>
                ...
                <Text style={styles.color_textPrivate}>
                    {" "}tapi untuk pesanan yang telah
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}di 'accept' oleh salon/barbershop 
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}tidak dapat di batalkan. Namun,
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}jika terjadi hal demikian, silahkan
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}dapat menghubungi kami pada
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}alamat dan kontak di bawah ini.
                </Text>
             </View>
