...
const inputRegistrasi = ({navigation, route}) => {
    ...
    const sendData = () => {
        ...
        if (form.password!=form.konfirm_password) {
            alert('konfirmasi kata sandi tidak cocok');
                ...
                var urlAksi = "http://192.168.43.91/api/api.php?op=registrasi";
                ...
                fetch(urlAksi,{
                    ...
                    body:"nama="+form.nama+"&password="+form.password+"&no_hp="+form.no_hp+"&alamat="+form.alamat+"&tgl_lahir="+form.tgl_lahir+"&email="+route.params.email,
                })
    ...
    return (
      <View style={styles.container}>
        ...
        >
            <ScrollView>
            <Text style={styles.color_textPrivate}>Silahkan masukkan data anda dengan benar!</Text>
    ...
    />
            ...
            <View style={styles.action}>
                <TextInput 
                    ...
                    value={form.konfirm_password} onChangeText={(value)=>onInputChange(value, 'konfirm_password')}
                />
                <TouchableOpacity
