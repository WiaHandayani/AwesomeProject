...
const InputPw = ({navigation, route}) => {
    ...
    const sendData = () => {
        ...
        if (form.password!=form.konfirm_password) {
            alert('konfirmasi kata sandi tidak sesuai');
                ...
                var urlAksi = "http://192.168.43.91/api/api.php?op=ganti_pw";
                ...
                fetch(urlAksi,{
                    ...
                    body:"password="+form.password+"&email="+route.params.email,
                })
                .then((response)=>response.json())
                .then((responseJson)=>{
                    if (responseJson=="Kata sandi berhasil diupdate") {
                     alert(responseJson);
                     handleGoTo("signin");
                    }else{
                        alert(responseJson);
    ...
    return (
      <View style={styles.container}>
        ...
        >
            ...
            <Text style={[styles.text_footer, {
                marginTop: 35
            }]}>Konfirmasi Kata Sandi Baru</Text>
            <View style={styles.action}>
                <TextInput 
