    ...
    <View style={{flex:1}}>
        <ScrollView>
            ...
            <View style={styles.textPrivate}>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Cara mencari salon/babershop</Text>
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}yang saya mau</Text>
            </View>
            <View style={styles.textPrivate}>
                <Text style={styles.color_textPrivate}>
                    {" "}Masuk ke menu 'Cari' (setelah
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}login) lalu ketikkan nama
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}salon/barbershop yang ingin
                </Text>
                <Text style={styles.color_textPrivate}>
                    {" "}Anda tuju pada kolom pencarian.
                </Text>
             </View>
